...
thousands more to come in the next decades. In this context automation of is key to keeping costs down. Faults are common in 
satellites [cite]. 
Fault-tolerant control (FTC) is an attractive method of 
FTC is attracting  growing attention in the space research community due to the nature of space operations.
Space operations
