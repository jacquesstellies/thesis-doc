\begin{figure}[h]
    ...
    \begin{tikzpicture}[
        ...
        \node[draw, dashed, inner sep=0.35cm, fit=(dyn), label={above:Subsystem $i-1$}] {};
        \node[draw, dashed, inner sep=0.35cm, fit=(kin), label={above:Subsystem $i$}] {};
    \end{tikzpicture}
    \caption{Simplified cascade block diagram of the satellite attitude dynamics (subsystem $i-1$) and kinematics (subsystem $i$).}
