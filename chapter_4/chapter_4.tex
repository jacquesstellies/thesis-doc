...
To estimate$\vec{d}$ Nadafi and Kabganian employ a finite-time nonlinear disturbance observer (FNDO) derived in \cite{shihuaDisturbanceObserverBasedControl}. This is a sliding-mode observer that estimates the lumped disturbance $\vec{d}$ in finite time, with the following dynamics:
\begin{align}
