...
\babelprovide[import]{afrikaans}  % afrikaans.ldf not in base TeX Live; use locale
...
\usepackage{tabularx}
\usepackage{multirow}
\usepackage{placeins}  % \FloatBarrier to stop figures/tables drifting across sections
\newcommand{\mytable}{
    \centering
    \small
